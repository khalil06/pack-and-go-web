 ...
 * Personality
 *
 * @ORM\Table(name="personality", indexes={@ORM\Index(name="processing_fk", columns={"processing"}), @ORM\Index(name="interaction_fk", columns={"interaction"}), @ORM\Index(name="social_fk", columns={"social"}), @ORM\Index(name="decision_making_fk", columns={"decision_making"})})
 * @ORM\Entity
 */
class Personality
{
