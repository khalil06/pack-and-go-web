...
class TicketController extends AbstractController
{
    ...
    /**
     * @Route("/{numTicket}", name="app_ticket_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{numTicket}/edit", name="app_ticket_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{numTicket}", name="app_ticket_delete", methods={"POST"})
     */
    public function delete(Request $request, Ticket $ticket, TicketRepository $ticketRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$ticket->getNumTicket(), $request->request->get('_token'))) {
